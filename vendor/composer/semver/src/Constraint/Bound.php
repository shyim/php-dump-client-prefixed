...
class Bound
{
     ...
     * @return bool
     */
    public function compareTo(\_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound $other, $operator)
    {
    ...
    {
        return new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \true);
    }
    /**
     * @return self
     */
    ...
    {
        return new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound(\PHP_INT_MAX . '.0.0.0', \false);
    }
}
