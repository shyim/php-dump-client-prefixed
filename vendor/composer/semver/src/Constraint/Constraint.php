 ...
 */
class Constraint implements \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\ConstraintInterface
{
     ...
     * @return bool
     */
    public function matchSpecific(\_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
    ...
    private function extractBounds()
    {
        ...
        // Branches
        if (\strpos($this->version, 'dev-') === 0) {
            $this->lowerBound = \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound::zero();
            $this->upperBound = \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound::positiveInfinity();
            return;
        }
        switch ($this->operator) {
            case self::OP_EQ:
                $this->lowerBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \true);
                $this->upperBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_LT:
                $this->lowerBound = \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \false);
                break;
            case self::OP_LE:
                $this->lowerBound = \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound::zero();
                $this->upperBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \true);
                break;
            case self::OP_GT:
                $this->lowerBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \false);
                $this->upperBound = \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound::positiveInfinity();
                break;
            case self::OP_GE:
                $this->lowerBound = new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound($this->version, \true);
