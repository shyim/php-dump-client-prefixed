 ...
 */
class MatchNoneConstraint implements \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \_PhpScoper3fe455fa007d\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
