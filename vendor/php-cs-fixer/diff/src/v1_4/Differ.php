 ...
 */
namespace _PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4;

use _PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence;
use _PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\TimeEfficientImplementation;
use _PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\MemoryEfficientImplementation;
/**
 * Diff implementation.
 */
class Differ
{
     ...
     * @return string
     */
    public function diff($from, $to, \_PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence $lcs = null)
    {
     ...
     * @return array
     */
    public function diffToArray($from, $to, \_PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence $lcs = null)
    {
        if (\is_string($from)) {
    ...
    private function selectLcsImplementation(array $from, array $to)
    {
        ...
        if ($this->calculateEstimatedFootprint($from, $to) > $memoryLimit) {
            return new \_PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\MemoryEfficientImplementation();
        }
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\Diff\v1_4\LCS\TimeEfficientImplementation();
    }
    /**
