...
final class Connection implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\ServerInfoAwareConnection
{
    ...
    public function __construct($serverName, $connectionOptions)
    {
        ...
        $this->conn = $conn;
        $this->lastInsertId = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\SQLSrv\LastInsertId();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\SQLSrv\Statement($this->conn, $sql, $this->lastInsertId);
    }
