...
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\ExpressionBuilder;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Result;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Statement;
...
class QueryBuilder
{
    ...
    {
        if (!(\func_num_args() === 1 && $predicates instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression)) {
            $predicates = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::and(...\func_get_args());
        }
    ...
    public function andWhere($where)
    {
        ...
        if ($where instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression && $where->getType() === \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::TYPE_AND) {
            $where = $where->with(...$args);
        } else {
            \array_unshift($args, $where);
            $where = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::and(...$args);
        }
    ...
    public function orWhere($where)
    {
        $args = \func_get_args();
        $where = $this->getQueryPart('where');
        if ($where instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression && $where->getType() === \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::TYPE_OR) {
            $where = $where->with(...$args);
        } else {
            \array_unshift($args, $where);
            $where = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::or(...$args);
        }
        return $this->add('where', $where, \true);
    }
    /**
    ...
    {
        if (!(\func_num_args() === 1 && $having instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression)) {
            $having = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::and(...\func_get_args());
        }
    ...
    public function andHaving($having)
    {
        ...
        if ($having instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression && $having->getType() === \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::TYPE_AND) {
            $having = $having->with(...$args);
        } else {
            \array_unshift($args, $having);
            $having = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::and(...$args);
        }
        return $this->add('having', $having);
    }
    /**
    ...
    public function orHaving($having)
    {
        $args = \func_get_args();
        $having = $this->getQueryPart('having');
        if ($having instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression && $having->getType() === \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::TYPE_OR) {
            $having = $having->with(...$args);
        } else {
            \array_unshift($args, $having);
            $having = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\Expression\CompositeExpression::or(...$args);
        }
        return $this->add('having', $having);
    }
    /**
    ...
    private function verifyAllAliasesAreKnown(array $knownAliases) : void
    {
        foreach ($this->sqlParts['join'] as $fromAlias => $joins) {
            if (!isset($knownAliases[$fromAlias])) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\QueryException::unknownAlias($fromAlias, \array_keys($knownAliases));
            }
        }
    }
    /**
     ...
     */
    public function createNamedParameter($value, $type = \_PhpScoper3fe455fa007d\Doctrine\DBAL\ParameterType::STRING, $placeHolder = null)
    {
        if ($placeHolder === null) {
            $this->boundCounter++;
     ...
     * @return string
     */
    public function createPositionalParameter($value, $type = \_PhpScoper3fe455fa007d\Doctrine\DBAL\ParameterType::STRING)
    {
        ...
        if (isset($this->sqlParts['join'][$fromAlias])) {
            foreach ($this->sqlParts['join'][$fromAlias] as $join) {
                if (\array_key_exists($join['joinAlias'], $knownAliases)) {
                    throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Query\QueryException::nonUniqueAlias($join['joinAlias'], \array_keys($knownAliases));
                }
