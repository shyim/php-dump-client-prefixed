...
namespace _PhpScoper3fe455fa007d\Doctrine\DBAL\SQL;
...
final class Parser
{
     ...
     */
    public function parse(string $sql, \_PhpScoper3fe455fa007d\Doctrine\DBAL\SQL\Parser\Visitor $visitor) : void
    {
