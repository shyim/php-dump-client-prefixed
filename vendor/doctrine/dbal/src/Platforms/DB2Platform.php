...
use function strpos;
class DB2Platform extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform
{
    ...
    {
        if ($doctrineType->getName() === \_PhpScoper3fe455fa007d\Doctrine\DBAL\Types\Types::BOOLEAN) {
     ...
     */
    private function gatherAlterColumnSQL(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Identifier $table, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\ColumnDiff $columnDiff, array &$sql, array &$queryParts) : void
    {
     ...
     * @return string[]
     */
    private function getAlterColumnClausesSQL(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\ColumnDiff $columnDiff)
    {
    ...
    {
        return \_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\Keywords\DB2Keywords::class;
    }
