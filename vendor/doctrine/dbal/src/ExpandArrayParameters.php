...
use _PhpScoper3fe455fa007d\Doctrine\DBAL\ArrayParameters\Exception\MissingNamedParameter;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\ArrayParameters\Exception\MissingPositionalParameter;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\SQL\Parser\Visitor;
...
use function substr;
final class ExpandArrayParameters implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\SQL\Parser\Visitor
{
    ...
    public function acceptPositionalParameter(string $sql) : void
    {
        ...
        if (!\array_key_exists($index, $this->originalParameters)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\ArrayParameters\Exception\MissingPositionalParameter::new($index);
        }
    ...
    public function acceptNamedParameter(string $sql) : void
    {
        ...
        if (!\array_key_exists($name, $this->originalParameters)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\ArrayParameters\Exception\MissingNamedParameter::new($name);
        }
    ...
    private function acceptParameter($key, $value) : void
    {
        ...
        if ($type !== \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection::PARAM_INT_ARRAY && $type !== \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection::PARAM_STR_ARRAY) {
        ...
        $this->appendTypedParameter($value, $type - \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection::ARRAY_PARAM_OFFSET);
    }
    /**
