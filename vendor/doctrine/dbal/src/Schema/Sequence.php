 ...
 * Sequence structure.
 */
class Sequence extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset
{
    /** @var int */
     ...
     * @return bool
     */
    public function isAutoIncrementsFor(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table $table)
    {
