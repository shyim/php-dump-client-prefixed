...
class Index extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Constraint
{
    /**
    ...
    {
        $this->_columns[$column] = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Identifier($column);
    }
    /**
     * {@inheritdoc}
     */
     ...
     * @return bool
     */
    public function isFullfilledBy(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $other)
    {
     ...
     * @return bool
     */
    public function overrules(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $other)
    {
        if ($other->isPrimary()) {
            return \false;
        }
     ...
     * @return bool
     */
    private function samePartialIndex(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $other)
    {
