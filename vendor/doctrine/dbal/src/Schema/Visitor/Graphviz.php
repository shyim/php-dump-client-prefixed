 ...
 */
class Graphviz extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Visitor\AbstractVisitor
{
    /** @var string */
    private $output = '';
    /**
     ...
     * @return string
     */
    private function createTableLabel(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table $table)
    {
        // Start the table
