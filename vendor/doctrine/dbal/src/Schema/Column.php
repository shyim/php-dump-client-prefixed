...
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Exception\UnknownColumnOption;
 ...
 */
class Column extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset
{
    /** @var Type */
    protected $_type;
    /** @var int|null */
     ...
     */
    public function __construct($name, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Types\Type $type, array $options = [])
    {
        $this->_setName($name);
        $this->setType($type);
    ...
    public function setOptions(array $options)
    {
        foreach ($options as $name => $value) {
            ...
            if (!\method_exists($this, $method)) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Exception\UnknownColumnOption::new($name);
            }
            $this->{$method}($value);
        }
        return $this;
     ...
     * @return Column
     */
    public function setType(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Types\Type $type)
    {
        $this->_type = $type;
        return $this;
    }
