 ...
 */
class UniqueConstraint extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Constraint
{
    /**
     ...
     */
    public function addFlag(string $flag) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\UniqueConstraint
    {
    ...
    {
        $this->columns[$column] = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Identifier($column);
    }
}
