...
class SchemaDiff
{
     ...
     */
    public function __construct($newTables = [], $changedTables = [], $removedTables = [], ?\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Schema $fromSchema = null)
    {
     ...
     * @return string[]
     */
    public function toSaveSql(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform)
    {
     ...
     * @return string[]
     */
    protected function _toSql(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform, $saveMode = \false)
    {
        $sql = [];
        ...
        foreach ($this->newTables as $table) {
            $sql = \array_merge($sql, $platform->getCreateTableSQL($table, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform::CREATE_INDEXES));
