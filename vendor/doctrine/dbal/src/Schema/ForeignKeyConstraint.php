 ...
 */
class ForeignKeyConstraint extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Constraint
{
    /**
    ...
    public function __construct(array $localColumnNames, $foreignTableName, array $foreignColumnNames, $name = null, array $options = [])
    {
        ...
        if ($foreignTableName instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table) {
            $this->_foreignTableName = $foreignTableName;
        } else {
            $this->_foreignTableName = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Identifier($foreignTableName);
        }
    ...
    private function createIdentifierMap(array $names) : array
    {
        ...
        foreach ($names as $name) {
            $identifiers[$name] = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Identifier($name);
        }
        return $identifiers;
    }
    /**
     ...
     * @return void
     */
    public function setLocalTable(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table $table)
    {
     ...
     * @return string[]
     */
    public function getQuotedLocalColumns(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform)
    {
        $columns = [];
     ...
     * @return string
     */
    public function getQuotedForeignTableName(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform)
    {
     ...
     * @return string[]
     */
    public function getQuotedForeignColumns(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform)
    {
        $columns = [];
     ...
     * @return bool
     */
    public function intersectsIndexColumns(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $index)
    {
