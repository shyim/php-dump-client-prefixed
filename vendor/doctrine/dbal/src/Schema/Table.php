...
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Exception\InvalidTableName;
 ...
 */
class Table extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\AbstractAsset
{
    /** @var Column[] */
    protected $_columns = [];
    /** @var Index[] */
    ...
    {
        if ($name === '') {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Exception\InvalidTableName::new($name);
        }
        $this->_setName($name);
     ...
     * @return void
     */
    public function setSchemaConfig(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaConfig $schemaConfig)
    {
    ...
    {
        if ($this->_schemaConfig instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaConfig) {
     ...
     * @return self
     */
    public function addUniqueConstraint(array $columnNames, ?string $indexName = null, array $flags = [], array $options = []) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table
    {
        if ($indexName === null) {
    ...
    public function dropIndex($name)
    {
        ...
        if (!$this->hasIndex($name)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexDoesNotExist($name, $this->_name);
        }
    ...
    public function renameIndex($oldName, $newName = null)
    {
        ...
        if (!$this->hasIndex($oldName)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexDoesNotExist($oldName, $this->_name);
        }
        if ($this->hasIndex($normalizedNewName)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexAlreadyExists($normalizedNewName, $this->_name);
        }
    ...
    private function _createIndex(array $columnNames, $indexName, $isUnique, $isPrimary, array $flags = [], array $options = [])
    {
        if (\preg_match('(([^a-zA-Z0-9_]+))', $this->normalizeIdentifier($indexName)) === 1) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexNameInvalid($indexName);
        }
        foreach ($columnNames as $columnName) {
            if (!$this->hasColumn($columnName)) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::columnDoesNotExist($columnName, $this->_name);
            }
        }
        return new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index($indexName, $columnNames, $isUnique, $isPrimary, $flags, $options);
    }
    /**
     * @param string  $name
    ...
    {
        $column = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Column($name, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Types\Type::getType($typeName), $options);
        $this->_addColumn($column);
        return $column;
    }
    /**
    ...
    public function addForeignKeyConstraint($foreignTable, array $localColumnNames, array $foreignColumnNames, array $options = [], $name = null)
    {
        ...
        if ($foreignTable instanceof \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table) {
            foreach ($foreignColumnNames as $columnName) {
                if (!$foreignTable->hasColumn($columnName)) {
                    throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::columnDoesNotExist($columnName, $foreignTable->getName());
                }
            }
        }
        ...
        $constraint = new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\ForeignKeyConstraint($localColumnNames, $foreignTable, $foreignColumnNames, $name, $options);
     ...
     * @throws SchemaException
     */
    protected function _addColumn(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Column $column)
    {
        $columnName = $column->getName();
        $columnName = $this->normalizeIdentifier($columnName);
        if (isset($this->_columns[$columnName])) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::columnAlreadyExists($this->getName(), $columnName);
        }
     ...
     * @throws SchemaException
     */
    protected function _addIndex(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $indexCandidate)
    {
        ...
        if (isset($this->_indexes[$indexName]) && !\in_array($indexName, $replacedImplicitIndexes, \true) || $this->_primaryKeyName !== null && $indexCandidate->isPrimary()) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexAlreadyExists($indexName, $this->_name);
        }
     ...
     * @return self
     */
    protected function _addUniqueConstraint(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\UniqueConstraint $constraint) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Table
    {
     ...
     * @return self
     */
    protected function _addForeignKeyConstraint(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\ForeignKeyConstraint $constraint)
    {
    ...
    public function getForeignKey($name)
    {
        ...
        if (!$this->hasForeignKey($name)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::foreignKeyDoesNotExist($name, $this->_name);
        }
     ...
     */
    public function getUniqueConstraint(string $name) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\UniqueConstraint
    {
        $name = $this->normalizeIdentifier($name);
        if (!$this->hasUniqueConstraint($name)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::uniqueConstraintDoesNotExist($name, $this->_name);
        }
    ...
    public function getColumn($name)
    {
        ...
        if (!$this->hasColumn($name)) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::columnDoesNotExist($name, $this->_name);
        }
    ...
    public function getPrimaryKeyColumns()
    {
        ...
        if ($primaryKey === null) {
            throw new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception('Table ' . $this->getName() . ' has no primary key.');
        }
     ...
     * @throws SchemaException
     */
    private function _createUniqueConstraint(array $columnNames, string $indexName, array $flags = [], array $options = []) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\UniqueConstraint
    {
        if (\preg_match('(([^a-zA-Z0-9_]+))', $this->normalizeIdentifier($indexName)) === 1) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\SchemaException::indexNameInvalid($indexName);
        }
        ...
        return new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\UniqueConstraint($indexName, $columnNames, $flags, $options);
    }
    /**
