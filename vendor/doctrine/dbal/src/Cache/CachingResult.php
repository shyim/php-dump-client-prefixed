 ...
 */
class CachingResult implements \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\Result
{
    /** @var Cache */
    private $cache;
    /** @var string */
     ...
     * @param int    $lifetime
     */
    public function __construct(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Result $result, \_PhpScoper3fe455fa007d\Doctrine\Common\Cache\Cache $cache, $cacheKey, $realKey, $lifetime)
    {
        $this->result = $result;
        $this->cache = $cache;
