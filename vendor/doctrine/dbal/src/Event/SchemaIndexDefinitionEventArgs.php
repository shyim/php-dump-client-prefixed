 ...
 */
class SchemaIndexDefinitionEventArgs extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Event\SchemaEventArgs
{
    /** @var Index|null */
    private $index;
    /**
     ...
     * @param string  $table
     */
    public function __construct(array $tableIndex, $table, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection $connection)
    {
     ...
     */
    public function setIndex(?\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\Index $index = null)
    {
        $this->index = $index;
        return $this;
    }
