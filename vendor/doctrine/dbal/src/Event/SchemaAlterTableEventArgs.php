 ...
 */
class SchemaAlterTableEventArgs extends \_PhpScoper3fe455fa007d\Doctrine\DBAL\Event\SchemaEventArgs
{
    /** @var TableDiff */
    private $tableDiff;
    ...
    /** @var string[] */
    private $sql = [];
    public function __construct(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Schema\TableDiff $tableDiff, \_PhpScoper3fe455fa007d\Doctrine\DBAL\Platforms\AbstractPlatform $platform)
    {
