...
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\IBMDB2;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\Mysqli;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\OCI8;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO;
use _PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\SQLSrv;
...
final class DriverManager
{
     ...
     */
    private const DRIVER_MAP = ['pdo_mysql' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO\MySQL\Driver::class, 'pdo_sqlite' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO\SQLite\Driver::class, 'pdo_pgsql' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO\PgSQL\Driver::class, 'pdo_oci' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO\OCI\Driver::class, 'oci8' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\OCI8\Driver::class, 'ibm_db2' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\IBMDB2\Driver::class, 'pdo_sqlsrv' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver::class, 'mysqli' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\Mysqli\Driver::class, 'sqlsrv' => \_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver\SQLSrv\Driver::class];
    /**
     ...
     */
    public static function getConnection(array $params, ?\_PhpScoper3fe455fa007d\Doctrine\DBAL\Configuration $config = null, ?\_PhpScoper3fe455fa007d\Doctrine\Common\EventManager $eventManager = null) : \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection
    {
        ...
        if (isset($params['driverClass'])) {
            if (!\in_array(\_PhpScoper3fe455fa007d\Doctrine\DBAL\Driver::class, \class_implements($params['driverClass']), \true)) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception::invalidDriverClass($params['driverClass']);
            }
            ...
            if (!isset(self::DRIVER_MAP[$params['driver']])) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception::unknownDriver($params['driver'], \array_keys(self::DRIVER_MAP));
            }
            $driverClass = self::DRIVER_MAP[$params['driver']];
        } else {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception::driverRequired();
        }
        $driver = new $driverClass();
        foreach ($config->getMiddlewares() as $middleware) {
            $driver = $middleware->wrap($driver);
        }
        $wrapperClass = \_PhpScoper3fe455fa007d\Doctrine\DBAL\Connection::class;
        if (isset($params['wrapperClass'])) {
            if (!\is_subclass_of($params['wrapperClass'], $wrapperClass)) {
                throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception::invalidWrapperClass($params['wrapperClass']);
            }
    ...
    private static function parseDatabaseUrl(array $params) : array
    {
        ...
        $url = \parse_url($url);
        if ($url === \false) {
            throw new \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception('Malformed parameter "url".');
        }
    ...
    private static function parseDatabaseUrlScheme(?string $scheme, array $params) : array
    {
        ...
        if (!isset($params['driverClass']) && !isset($params['driver'])) {
            throw \_PhpScoper3fe455fa007d\Doctrine\DBAL\Exception::driverRequired($params['url']);
        }
        return $params;
    }
}
