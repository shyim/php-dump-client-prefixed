 ...
 */
class MongoDBCache extends \_PhpScoper3fe455fa007d\Doctrine\Common\Cache\CacheProvider
{
    /**
    ...
    public function __construct($collection)
    {
        if ($collection instanceof \MongoCollection) {
            @\trigger_error('Using a MongoCollection instance for creating a cache adapter is deprecated and will be removed in 2.0', \E_USER_DEPRECATED);
            $this->provider = new \_PhpScoper3fe455fa007d\Doctrine\Common\Cache\LegacyMongoDBCache($collection);
        } elseif ($collection instanceof \_PhpScoper3fe455fa007d\MongoDB\Collection) {
            $this->provider = new \_PhpScoper3fe455fa007d\Doctrine\Common\Cache\ExtMongoDBCache($collection);
        } else {
