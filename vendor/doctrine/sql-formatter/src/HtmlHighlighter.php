...
use const PHP_EOL;
final class HtmlHighlighter implements \_PhpScoper3fe455fa007d\Doctrine\SqlFormatter\Highlighter
{
    ...
    {
        return \sprintf('%s<span %s>%s</span>', \PHP_EOL, $this->htmlAttributes[self::HIGHLIGHT_ERROR], $value);
    }
