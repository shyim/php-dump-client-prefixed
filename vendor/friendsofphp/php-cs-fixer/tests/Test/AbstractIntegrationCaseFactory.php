 ...
 * @internal
 */
abstract class AbstractIntegrationCaseFactory implements \_PhpScoper3fe455fa007d\PhpCsFixer\Tests\Test\IntegrationCaseFactoryInterface
{
    /**
    ...
    public function create(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file)
    {
        try {
            ...
            return new \_PhpScoper3fe455fa007d\PhpCsFixer\Tests\Test\IntegrationCase($file->getRelativePathname(), $this->determineTitle($file, $match['title']), $this->determineSettings($file, $match['settings']), $this->determineRequirements($file, $match['requirements']), $this->determineConfig($file, $match['config']), $this->determineRuleset($file, $match['ruleset']), $this->determineExpectedCode($file, $match['expect']), $this->determineInputCode($file, $match['input']));
     ...
     * @return array
     */
    protected function determineConfig(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return array
     */
    protected function determineRequirements(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return RuleSet
     */
    protected function determineRuleset(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSet($this->parseJson($config));
    }
    /**
     ...
     * @return string
     */
    protected function determineTitle(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
        return $config;
    }
    /**
     ...
     * @return array
     */
    protected function determineSettings(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $config)
    {
     ...
     * @return string
     */
    protected function determineExpectedCode(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    protected function determineInputCode(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $code)
    {
     ...
     * @return null|string
     */
    private function determineCode(\_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo $file, $code, $suffix)
    {
        if (null !== $code) {
            return $code;
        }
        $candidateFile = new \_PhpScoper3fe455fa007d\Symfony\Component\Finder\SplFileInfo($file->getPathname() . $suffix, '', '');
