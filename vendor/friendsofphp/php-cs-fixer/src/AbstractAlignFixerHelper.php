...
abstract class AbstractAlignFixerHelper
{
    ...
    public function fix(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens)
    {
     ...
     * @param int $endAt
     */
    protected abstract function injectAlignmentPlaceholders(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $startAt, $endAt);
    /**
     * Look for group of placeholders, and provide vertical alignment.
     *
     * @return string
     */
    protected function replacePlaceholder(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens)
    {
