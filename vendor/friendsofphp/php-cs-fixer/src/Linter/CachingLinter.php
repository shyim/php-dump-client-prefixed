 ...
 * @internal
 */
final class CachingLinter implements \_PhpScoper3fe455fa007d\PhpCsFixer\Linter\LinterInterface
{
    /**
     * @var LinterInterface
     */
     ...
     */
    private $cache = [];
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\Linter\LinterInterface $linter)
    {
