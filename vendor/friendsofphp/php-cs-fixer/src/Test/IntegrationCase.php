 ...
 */
namespace _PhpScoper3fe455fa007d\PhpCsFixer\Test;

use _PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSet;
use _PhpScoper3fe455fa007d\PhpCsFixer\Tests\Test\IntegrationCase as BaseIntegrationCase;
/**
...
final class IntegrationCase
{
     ...
     */
    public function __construct($fileName, $title, array $settings, array $requirements, array $config, \_PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSet $ruleset, $expectedCode, $inputCode)
    {
        $this->base = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tests\Test\IntegrationCase($fileName, $title, $settings, $requirements, $config, $ruleset, $expectedCode, $inputCode);
    ...
    {
        @\trigger_error(\sprintf('The "%s" method is deprecated. You should stop using it, as it will be removed in 3.0 version.', __METHOD__), \E_USER_DEPRECATED);
        $settings = $this->base->getSettings();
        return isset($settings['checkPriority']) ? $settings['checkPriority'] : \true;
    }
}
