 ...
 * @internal
 */
final class FileCacheManager implements \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\CacheManagerInterface
{
    /**
     ...
     * @param bool $isDryRun
     */
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\Cache\FileHandlerInterface $handler, \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\SignatureInterface $signature, $isDryRun = \false, \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\DirectoryInterface $cacheDirectory = null)
    {
        $this->handler = $handler;
        $this->signature = $signature;
        $this->isDryRun = $isDryRun;
        $this->cacheDirectory = $cacheDirectory ?: new \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\Directory('');
        $this->readCache();
    }
    ...
    private function readCache()
    {
        ...
        if (!$cache || !$this->signature->equals($cache->getSignature())) {
            $cache = new \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\Cache($this->signature);
        }
        $this->cache = $cache;
    }
