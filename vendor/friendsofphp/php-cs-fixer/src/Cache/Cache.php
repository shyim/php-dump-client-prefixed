 ...
 * @internal
 */
final class Cache implements \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\CacheInterface
{
    /**
     ...
     */
    private $hashes = [];
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\Cache\SignatureInterface $signature)
    {
    ...
    public static function fromJson($json)
    {
        ...
        $signature = new \_PhpScoper3fe455fa007d\PhpCsFixer\Cache\Signature($data['php'], $data['version'], $data['indent'], $data['lineEnding'], $data['rules']);
