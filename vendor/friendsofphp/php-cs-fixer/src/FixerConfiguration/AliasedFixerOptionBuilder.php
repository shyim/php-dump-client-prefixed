...
final class AliasedFixerOptionBuilder
{
     ...
     */
    private $alias;
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionBuilder $optionBuilder, $alias)
    {
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\AliasedFixerOption($this->optionBuilder->getOption(), $this->alias);
    }
}
