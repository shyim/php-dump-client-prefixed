...
final class DeprecatedFixerOption implements \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\DeprecatedFixerOptionInterface
{
    /**
     ...
     */
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionInterface $option, $deprecationMessage)
    {
        $this->option = $option;
