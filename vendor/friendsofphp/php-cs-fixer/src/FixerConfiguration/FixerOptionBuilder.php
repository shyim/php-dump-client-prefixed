...
final class FixerOptionBuilder
{
    ...
    {
        $option = new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOption($this->name, $this->description, $this->isRequired, $this->default, $this->allowedTypes, $this->allowedValues, $this->normalizer);
        if (null !== $this->deprecationMessage) {
            $option = new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\DeprecatedFixerOption($option, $this->deprecationMessage);
        }
        return $option;
    }
}
