 ...
 */
final class FixerConfigurationResolverRootless implements \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    /**
    ...
    {
        $this->resolver = new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerConfigurationResolver($options);
        $this->fixerName = $fixerName;
        $names = \array_map(static function (\_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionInterface $option) {
            return $option->getName();
        }, $this->resolver->getOptions());
        if (!\in_array($root, $names, \true)) {
