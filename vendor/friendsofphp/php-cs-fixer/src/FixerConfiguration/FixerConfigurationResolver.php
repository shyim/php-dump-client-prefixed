...
final class FixerConfigurationResolver implements \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    /**
    ...
    {
        $resolver = new \_PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\OptionsResolver();
            ...
            if ($option instanceof \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\AliasedFixerOption) {
                ...
                if (\array_key_exists($alias, $options)) {
                    if (\array_key_exists($name, $options)) {
                        throw new \_PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException(\sprintf('Aliased option "%s"/"%s" is passed multiple times.', $name, $alias));
                    }
     ...
     * @return $this
     */
    private function addOption(\_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionInterface $option)
    {
        $name = $option->getName();
