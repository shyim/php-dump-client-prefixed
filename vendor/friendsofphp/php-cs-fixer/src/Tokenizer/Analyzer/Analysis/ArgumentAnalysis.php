 ...
 */
namespace _PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\Analysis;
...
final class ArgumentAnalysis
{
     ...
     */
    public function __construct($name, $nameIndex, $default, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\Analysis\TypeAnalysis $typeAnalysis = null)
    {
        $this->name = $name;
