...
final class ArgumentsAnalyzer
{
     ...
     * @return int
     */
    public function countArguments(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $openParenthesis, $closeParenthesis)
    {
     ...
     */
    public function getArguments(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $openParenthesis, $closeParenthesis)
    {
        $arguments = [];
        ...
        for (; $paramContentIndex < $closeParenthesis; ++$paramContentIndex) {
            ...
            $blockDefinitionProbe = \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens::detectBlockType($token);
     ...
     */
    public function getArgumentInfo(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $argumentStart, $argumentEnd)
    {
        ...
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\Analysis\ArgumentAnalysis($info['name'], $info['name_index'], $info['default'], $info['type'] ? new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\Analysis\TypeAnalysis($info['type'], $info['type_index_start'], $info['type_index_end']) : null);
    }
}
