...
final class CommentsAnalyzer
{
     ...
     * @return bool
     */
    public function isHeaderComment(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
        ...
        if ($tokens[$prevIndex]->equals(';')) {
            ...
            $braceOpenIndex = $tokens->findBlockStart(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens::BLOCK_TYPE_PARENTHESIS_BRACE, $braceCloseIndex);
     ...
     * @return bool
     */
    public function isBeforeStructuralElement(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
        $token = $tokens[$index];
     ...
     * @return null|array
     */
    public function getCommentBlockIndices(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
     ...
     * @return bool
     */
    private function isStructuralElement(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token $token)
    {
     ...
     * @return bool
     */
    private function isValidControl(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token $docsToken, $controlIndex)
    {
     ...
     * @return bool
     */
    private function isValidLanguageConstruct(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token $docsToken, $languageConstructIndex)
    {
        static $languageStructures = [\T_LIST, \T_PRINT, \T_ECHO, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_DESTRUCTURING_SQUARE_BRACE_OPEN];
        if (!$tokens[$languageConstructIndex]->isGivenKind($languageStructures)) {
            return \false;
        }
        $endKind = $tokens[$languageConstructIndex]->isGivenKind(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_DESTRUCTURING_SQUARE_BRACE_OPEN) ? [\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_DESTRUCTURING_SQUARE_BRACE_CLOSE] : ')';
     ...
     * @return bool
     */
    private function isValidVariable(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
     ...
     * @return int
     */
    private function getLineBreakCount(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $whiteStart, $whiteEnd)
    {
        $lineCount = 0;
        for ($i = $whiteStart; $i < $whiteEnd; ++$i) {
            $lineCount += \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::matchAll('/\\R/u', $tokens[$i]->getContent());
        }
        return $lineCount;
    }
}
