...
final class BlocksAnalyzer
{
     ...
     * @return bool
     */
    public function isBlock(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $openIndex, $closeIndex)
    {
     ...
     * @return null|int
     */
    private function getBlockType(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token $token)
    {
        foreach (\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens::getBlockEdgeDefinitions() as $blockType => $definition) {
