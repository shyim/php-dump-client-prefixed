 ...
 * @internal
 */
final class ToolInfo implements \_PhpScoper3fe455fa007d\PhpCsFixer\ToolInfoInterface
{
    ...
    {
        if ($this->isInstalledByComposer()) {
            return \_PhpScoper3fe455fa007d\PhpCsFixer\Console\Application::VERSION . ':' . $this->getComposerVersion();
        }
        return \_PhpScoper3fe455fa007d\PhpCsFixer\Console\Application::VERSION;
    }
