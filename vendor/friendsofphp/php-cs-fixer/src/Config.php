 ...
 */
class Config implements \_PhpScoper3fe455fa007d\PhpCsFixer\ConfigInterface
{
    ...
    {
        if (null === $this->finder) {
            $this->finder = new \_PhpScoper3fe455fa007d\PhpCsFixer\Finder();
        }
        return $this->finder;
    }
    /**
    ...
    private function addCustomFixer(\_PhpScoper3fe455fa007d\PhpCsFixer\Fixer\FixerInterface $fixer)
    {
