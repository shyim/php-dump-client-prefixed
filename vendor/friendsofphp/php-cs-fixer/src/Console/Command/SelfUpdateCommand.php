...
use _PhpScoper3fe455fa007d\PhpCsFixer\Console\SelfUpdate\NewVersionCheckerInterface;
use _PhpScoper3fe455fa007d\PhpCsFixer\PharCheckerInterface;
 ...
 * @internal
 */
final class SelfUpdateCommand extends \_PhpScoper3fe455fa007d\Symfony\Component\Console\Command\Command
{
     ...
     */
    private $pharChecker;
    public function __construct(\_PhpScoper3fe455fa007d\PhpCsFixer\Console\SelfUpdate\NewVersionCheckerInterface $versionChecker, \_PhpScoper3fe455fa007d\PhpCsFixer\ToolInfoInterface $toolInfo, \_PhpScoper3fe455fa007d\PhpCsFixer\PharCheckerInterface $pharChecker)
    {
        parent::__construct();
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \_PhpScoper3fe455fa007d\Symfony\Component\Console\Input\InputOption('--force', '-f', \_PhpScoper3fe455fa007d\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
...
EOT
    ...
    protected function execute(\_PhpScoper3fe455fa007d\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper3fe455fa007d\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/^v?(?<major>\\d+)\\./', $currentVersion, $matches);
