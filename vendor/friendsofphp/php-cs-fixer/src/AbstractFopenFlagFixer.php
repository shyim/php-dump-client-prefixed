 ...
 * @author SpacePossum
 */
abstract class AbstractFopenFlagFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFunctionReferenceFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    protected abstract function fixFopenFlagToken(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $argumentStartIndex, $argumentEndIndex);
    /**
     * @param string $mode
     *
     * @return bool
