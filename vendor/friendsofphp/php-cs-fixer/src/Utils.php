...
final class Utils
{
    ...
    {
        return \strtolower(\_PhpScoper3fe455fa007d\PhpCsFixer\Preg::replace('/(?<!^)((?=[A-Z][^A-Z])|(?<![A-Z])(?=[A-Z]))/', '_', $string));
    }
    /**
     ...
     * @return string
     */
    public static function calculateTrailingWhitespaceIndent(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token $token)
    {
    ...
    public static function sortFixers(array $fixers)
    {
        ...
        return self::stableSort($fixers, static function (\_PhpScoper3fe455fa007d\PhpCsFixer\Fixer\FixerInterface $fixer) {
