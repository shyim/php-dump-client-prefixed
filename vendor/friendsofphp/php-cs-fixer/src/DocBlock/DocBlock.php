 ...
 */
namespace _PhpScoper3fe455fa007d\PhpCsFixer\DocBlock;
...
class DocBlock
{
    ...
    {
        foreach (\_PhpScoper3fe455fa007d\PhpCsFixer\Preg::split('/([^\\n\\r]+\\R*)/', $content, -1, \PREG_SPLIT_NO_EMPTY | \PREG_SPLIT_DELIM_CAPTURE) as $line) {
            $this->lines[] = new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line($line);
        }
    }
    /**
    ...
    public function getAnnotations()
    {
        ...
        for ($index = 0; $index < $total; ++$index) {
            if ($this->lines[$index]->containsATag()) {
                ...
                $annotation = new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Annotation($lines);
    ...
    public function makeMultiLine($indent, $lineEnd)
    {
        ...
        if ('' === $lineContent) {
            $this->lines = [new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line('/**' . $lineEnd), new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line($indent . ' *' . $lineEnd), new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line($indent . ' */')];
            return;
        }
        $this->lines = [new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line('/**' . $lineEnd), new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line($indent . ' * ' . $lineContent . $lineEnd), new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line($indent . ' */')];
    }
    public function makeSingleLine()
    {
        ...
        $usefulLines = \array_filter($this->lines, static function (\_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line $line) {
        ...
        $this->lines = [new \_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line('/** ' . $lineContent . ' */')];
    }
    /**
     * @param int $pos
     *
     ...
     * @return string
     */
    private function getSingleLineDocBlockEntry(\_PhpScoper3fe455fa007d\PhpCsFixer\DocBlock\Line $line)
    {
