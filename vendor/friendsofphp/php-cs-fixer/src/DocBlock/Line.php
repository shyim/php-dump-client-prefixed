...
class Line
{
    ...
    {
        return 0 !== \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/\\*\\s*\\S+/', $this->content) && '' !== \trim(\str_replace(['/', '*'], ' ', $this->content));
    }
    /**
    ...
    {
        return 0 !== \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/\\*\\s*@/', $this->content);
    }
    /**
    ...
    {
        $matched = \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/^(\\h*\\*)[^\\r\\n]*(\\r?\\n)$/', $this->content, $matches);
        if (1 !== $matched) {
            return;
        }
