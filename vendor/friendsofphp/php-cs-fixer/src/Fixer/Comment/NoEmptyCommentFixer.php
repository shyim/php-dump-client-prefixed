 ...
 * @author SpacePossum
 */
final class NoEmptyCommentFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer
{
    const TYPE_HASH = 1;
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('There should not be any empty comments.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php\n//\n#\n/* */\n")]);
    }
    /**
     * {@inheritdoc}
     */
     ...
     * @return array
     */
    private function getCommentBlock(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
    ...
    private function getLineBreakCount(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $whiteStart, $whiteEnd)
    {
        ...
        for ($i = $whiteStart; $i < $whiteEnd; ++$i) {
            $lineCount += \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::matchAll('/\\R/u', $tokens[$i]->getContent(), $matches);
        }
        return $lineCount;
    }
    /**
    ...
    private function isEmptyComment($content)
    {
        ...
        return 1 === \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match($mapper[$type], $content);
    }
}
