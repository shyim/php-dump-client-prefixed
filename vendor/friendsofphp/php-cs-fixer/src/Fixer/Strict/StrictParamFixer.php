 ...
 */
final class StrictParamFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function applyFix(\SplFileInfo $file, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens)
    {
        static $map = null;
        if (null === $map) {
            $trueToken = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, 'true']);
            $map = ['array_keys' => [null, null, $trueToken], 'array_search' => [null, null, $trueToken], 'base64_decode' => [null, $trueToken], 'in_array' => [null, null, $trueToken], 'mb_detect_encoding' => [null, [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, 'mb_detect_order']), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token('('), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token(')')], $trueToken]];
        }
    ...
    private function fixFunction(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $functionIndex, array $functionParams)
    {
        ...
        for ($i = $paramsQuantity; $i < $functionParamsQuantity; ++$i) {
            ...
            $tokensToInsert[] = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token(',');
            $tokensToInsert[] = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_WHITESPACE, ' ']);
