 ...
 */
final class PhpdocAnnotationWithoutDotFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer
{
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('PHPDoc annotation descriptions should not be a sentence.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample('<?php
/**
    ...
    protected function applyFix(\SplFileInfo $file, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens)
    {
        foreach ($tokens as $index => $token) {
            ...
            foreach ($annotations as $annotation) {
                ...
                if (1 !== \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/[.。]\\h*$/u', $content) || 0 !== \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match('/[.。](?!\\h*$)/u', $content, $matches)) {
                    continue;
                }
                $endLine = $doc->getLine($annotation->getEnd());
                $endLine->setContent(\_PhpScoper3fe455fa007d\PhpCsFixer\Preg::replace('/(?<![.。])[.。]\\h*(\\H+)$/u', '\\1', $endLine->getContent()));
                ...
                $content = \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::replaceCallback('/^(\\s*\\*\\s*@\\w+\\s+' . $optionalTypeRegEx . ')(\\p{Lu}?(?=\\p{Ll}|\\p{Zs}))(.*)$/', static function (array $matches) {
