 ...
 */
final class PhpdocScalarFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractPhpdocTypesFixer implements \_PhpScoper3fe455fa007d\PhpCsFixer\Fixer\ConfigurationDefinitionFixerInterface
{
    /**
     * The types to fix.
     *
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('Scalar types should always be written in the same form. `int` not `integer`, `bool` not `boolean`, `float` not `real` or `double`.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample('<?php
/**
 * @param integer $a
 * @param boolean $b
 * @param real $c
...
', ['types' => ['boolean']])]);
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerConfigurationResolver([(new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionBuilder('types', 'A map of types to fix.'))->setAllowedValues([new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\AllowedValueSubset(\array_keys(self::$types))])->setDefault(['boolean', 'double', 'integer', 'real', 'str'])->getOption()]);
    }
    /**
     * {@inheritdoc}
     */
