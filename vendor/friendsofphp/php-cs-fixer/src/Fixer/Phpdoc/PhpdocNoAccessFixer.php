 ...
 */
final class PhpdocNoAccessFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractProxyFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('`@access` annotations should be omitted from PHPDoc.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample('<?php
class Foo
{
    /**
     * @internal
