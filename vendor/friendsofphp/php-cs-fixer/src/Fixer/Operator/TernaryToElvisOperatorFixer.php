 ...
 * @author SpacePossum
 */
final class TernaryToElvisOperatorFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer
{
    /**
     * @internal
     *
    ...
    const VALID_BEFORE_ENDTYPES = [
        ...
        '{',
        '}',
        [\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_ARRAY_INDEX_CURLY_BRACE_OPEN],
        [\T_AND_EQUAL],
        // &=
        [\T_CONCAT_EQUAL],
        // .=
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('Use the Elvis operator `?:` where possible.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php\n\$foo = \$foo ? \$foo : 1;\n"), new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php \$foo = \$bar[a()] ? \$bar[a()] : 1; # \"risky\" sample, \"a()\" only gets called once after fixing\n")], null, 'Risky when relying on functions called on both sides of the `?` operator.');
    }
    /**
     * {@inheritdoc}
     *
    ...
    {
        $blockEdgeDefinitions = \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens::getBlockEdgeDefinitions();
     ...
     */
    private function getBeforeOperator(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index, array $blockEdgeDefinitions)
    {
     ...
     * @return array
     */
    private function getAfterOperator(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
     ...
     * @return bool
     */
    private function rangeEqualsRange(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, array $range1, array $range2)
    {
    ...
    private function clearMeaningfulFromRange(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, array $range)
    {
