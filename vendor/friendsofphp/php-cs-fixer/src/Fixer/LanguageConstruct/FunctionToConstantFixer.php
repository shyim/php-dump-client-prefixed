 ...
 * @author SpacePossum
 */
final class FunctionToConstantFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer implements \_PhpScoper3fe455fa007d\PhpCsFixer\Fixer\ConfigurationDefinitionFixerInterface
{
    /**
    ...
    public function __construct()
    {
        if (null === self::$availableFunctions) {
            self::$availableFunctions = ['get_called_class' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STATIC, 'static']), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_DOUBLE_COLON, '::']), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_CLASS_CONSTANT, 'class'])], 'get_class' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_CLASS_C, '__CLASS__'])], 'get_class_this' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STATIC, 'static']), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_DOUBLE_COLON, '::']), new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\CT::T_CLASS_CONSTANT, 'class'])], 'php_sapi_name' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, 'PHP_SAPI'])], 'phpversion' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, 'PHP_VERSION'])], 'pi' => [new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, 'M_PI'])]];
        }
        parent::__construct();
    }
    /**
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('Replace core functions calls returning constants with the constants.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php\necho phpversion();\necho pi();\necho php_sapi_name();\nclass Foo\n{\n    public function Bar()\n    {\n        echo get_class();\n        echo get_called_class();\n    }\n}\n"), new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php\necho phpversion();\necho pi();\nclass Foo\n{\n    public function Bar()\n    {\n        echo get_class();\n        get_class(\$this);\n        echo get_called_class();\n    }\n}\n", ['functions' => ['get_called_class', 'get_class_this', 'phpversion']])], null, 'Risky when any of the configured functions to replace are overridden.');
    }
    /**
     * {@inheritdoc}
     *
    ...
    protected function createConfigurationDefinition()
    {
        ...
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerConfigurationResolver([(new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\FixerOptionBuilder('functions', 'List of function names to fix.'))->setAllowedTypes(['array'])->setAllowedValues([new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerConfiguration\AllowedValueSubset($functionNames)])->setDefault(['get_class', 'php_sapi_name', 'phpversion', 'pi'])->getOption()]);
    }
    /**
     * @param int     $index
     ...
     */
    private function fixFunctionCallToConstant(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, $index, $braceOpenIndex, $braceCloseIndex, array $replacements)
    {
     ...
     * @return null|array
     */
    private function getReplaceCandidate(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\FunctionsAnalyzer $functionAnalyzer, $index)
    {
     ...
     * @return null|array
     */
    private function fixGetClassCall(\_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Analyzer\FunctionsAnalyzer $functionAnalyzer, $index)
    {
