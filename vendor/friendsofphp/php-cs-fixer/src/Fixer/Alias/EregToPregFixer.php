...
use _PhpScoper3fe455fa007d\PhpCsFixer\PregException;
 ...
 */
final class EregToPregFixer extends \_PhpScoper3fe455fa007d\PhpCsFixer\AbstractFixer
{
    /**
    ...
    {
        return new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\FixerDefinition('Replace deprecated `ereg` regular expression functions with `preg`.', [new \_PhpScoper3fe455fa007d\PhpCsFixer\FixerDefinition\CodeSample("<?php \$x = ereg('[A-Z]');\n")], null, 'Risky if the `ereg` function is overridden.');
    }
    /**
     * {@inheritdoc}
     */
    ...
    protected function applyFix(\SplFileInfo $file, \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Tokens $tokens)
    {
        ...
        foreach (self::$functions as $map) {
            ...
            while (null !== $currIndex) {
                ...
                $tokens[$match[0]] = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_STRING, $map[1]]);
                $tokens[$match[2]] = new \_PhpScoper3fe455fa007d\PhpCsFixer\Tokenizer\Token([\T_CONSTANT_ENCAPSED_STRING, $quote . $preg . $quote]);
            }
        }
    }
    /**
    ...
    {
        try {
            \_PhpScoper3fe455fa007d\PhpCsFixer\Preg::match($pattern, '');
            return \true;
        } catch (\_PhpScoper3fe455fa007d\PhpCsFixer\PregException $e) {
            return \false;
        }
    }
    /**
    ...
    private function getBestDelimiter($pattern)
    {
        ...
        \uasort($delimiters, static function ($a, $b) {
            if ($a[0] === $b[0]) {
                return \_PhpScoper3fe455fa007d\PhpCsFixer\Utils::cmpInt($a, $b);
            }
            return $a[0] < $b[0] ? -1 : 1;
        });
