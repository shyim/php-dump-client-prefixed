...
final class ReporterFactory
{
    ...
    public function registerBuiltInReporters()
    {
        ...
        if (null === $builtInReporters) {
            ...
            foreach (\_PhpScoper3fe455fa007d\Symfony\Component\Finder\Finder::create()->files()->name('*Reporter.php')->in(__DIR__) as $file) {
     ...
     * @return $this
     */
    public function registerReporter(\_PhpScoper3fe455fa007d\PhpCsFixer\Report\ReporterInterface $reporter)
    {
