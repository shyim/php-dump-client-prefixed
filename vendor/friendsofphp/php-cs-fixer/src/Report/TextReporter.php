 ...
 * @internal
 */
final class TextReporter implements \_PhpScoper3fe455fa007d\PhpCsFixer\Report\ReporterInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    private function getDiff($isDecoratedOutput, array $fixResult)
    {
        ...
        $diffFormatter = new \_PhpScoper3fe455fa007d\PhpCsFixer\Differ\DiffConsoleFormatter($isDecoratedOutput, \sprintf('<comment>      ---------- begin diff ----------</comment>%s%%s%s<comment>      ----------- end diff -----------</comment>', \PHP_EOL, \PHP_EOL));
