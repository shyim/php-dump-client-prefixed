 ...
 * @internal
 */
final class JsonReporter implements \_PhpScoper3fe455fa007d\PhpCsFixer\Report\ReporterInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function generate(\_PhpScoper3fe455fa007d\PhpCsFixer\Report\ReportSummary $reportSummary)
    {
        ...
        return $reportSummary->isDecoratedOutput() ? \_PhpScoper3fe455fa007d\Symfony\Component\Console\Formatter\OutputFormatter::escape($json) : $json;
    }
}
