 ...
 */
namespace _PhpScoper3fe455fa007d\PhpCsFixer\RuleSet;
 ...
 */
class RuleSet implements \_PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSetInterface
{
    /**
    ...
    public function getSetDefinitionNames()
    {
        ...
        return \_PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSets::getSetDefinitionNames();
    }
    /**
    ...
    {
        $rules = \_PhpScoper3fe455fa007d\PhpCsFixer\RuleSet\RuleSets::getSetDefinition($setName)->getRules();
        foreach ($rules as $name => $value) {
            if ('@' === $name[0]) {
