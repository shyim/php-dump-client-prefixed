 ...
 */
class UnicodeString extends \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function append(string ...$suffix) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if ($suffix instanceof \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString) {
    ...
    public function join(array $strings, string $lastGlue = null) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
     ...
     * @return static
     */
    public function normalize(int $form = self::NFC) : \_PhpScoper3fe455fa007d\parent
    {
        $str = clone $this;
    ...
    public function prepend(string ...$prefix) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, int $length = null) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, int $start = 0, int $length = null) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (\false === $delimiter) {
            throw new \_PhpScoper3fe455fa007d\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractString) {
