...
use _PhpScoper3fe455fa007d\Symfony\Component\String\UnicodeString;
use _PhpScoper3fe455fa007d\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScoper3fe455fa007d\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoper3fe455fa007d\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoper3fe455fa007d\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoper3fe455fa007d\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoper3fe455fa007d\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
