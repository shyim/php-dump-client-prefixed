 ...
 */
namespace _PhpScoper3fe455fa007d\Symfony\Component\String\Inflector;
 ...
 */
final class FrenchInflector implements \_PhpScoper3fe455fa007d\Symfony\Component\String\Inflector\InflectorInterface
{
    /**
    ...
    private static $pluralizeRegexp = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper3fe455fa007d\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', '_PhpScoper3fe455fa007d\\Mes\\2s'],
    ];
    /**
    ...
    private static $singularizeRegexp = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', '_PhpScoper3fe455fa007d\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', '_PhpScoper3fe455fa007d\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', '_PhpScoper3fe455fa007d\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', '_PhpScoper3fe455fa007d\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
