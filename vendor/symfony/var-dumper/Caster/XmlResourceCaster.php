...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScoper926b1169e332\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::$xmlErrors[$a['error_code']])) {
            $a['error_code'] = new \_PhpScoper926b1169e332\Symfony\Component\VarDumper\Caster\ConstStub(self::$xmlErrors[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
