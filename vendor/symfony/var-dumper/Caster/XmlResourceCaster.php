...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScopereaa8bfd44f12\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::$xmlErrors[$a['error_code']])) {
            $a['error_code'] = new \_PhpScopereaa8bfd44f12\Symfony\Component\VarDumper\Caster\ConstStub(self::$xmlErrors[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
