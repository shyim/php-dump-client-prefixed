...
class XmlResourceCaster
{
    ...
    public static function castXml($h, array $a, \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        ...
        if (isset(self::$xmlErrors[$a['error_code']])) {
            $a['error_code'] = new \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Caster\ConstStub(self::$xmlErrors[$a['error_code']], $a['error_code']);
        }
        return $a;
    }
}
