...
class AmqpCaster
{
    ...
    public static function castExchange(\AMQPExchange $c, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $prefix = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $a += [$prefix . 'flags' => self::extractFlags($c->getFlags())];
        $type = isset(self::$exchangeTypes[$c->getType()]) ? new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ConstStub(self::$exchangeTypes[$c->getType()], $c->getType()) : $c->getType();
        // Recent version of the extension already expose private properties
