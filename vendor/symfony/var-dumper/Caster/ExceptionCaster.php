...
use _PhpScoper3fe455fa007d\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext;
...
class ExceptionCaster
{
    ...
    public static function castError(\Error $e, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested, int $filter = 0)
    {
        return self::filterExceptionArray($stub->class, $a, "\0Error\0", $filter);
    }
    public static function castException(\Exception $e, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested, int $filter = 0)
    {
        return self::filterExceptionArray($stub->class, $a, "\0Exception\0", $filter);
    }
    public static function castErrorException(\ErrorException $e, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        if (isset($a[$s = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'severity'], self::$errorTypes[$a[$s]])) {
            $a[$s] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ConstStub(self::$errorTypes[$a[$s]], $a[$s]);
        }
        return $a;
    }
    public static function castThrowingCasterException(\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Exception\ThrowingCasterException $e, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $trace = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'trace';
        $prefix = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED;
        ...
        if (isset($a[$xPrefix . 'previous'], $a[$trace]) && $a[$xPrefix . 'previous'] instanceof \Exception) {
            ...
            $a[$trace] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\TraceStub($b[$xPrefix . 'trace'], \false, 0, -\count($a[$trace]->value));
        }
        unset($a[$xPrefix . 'previous'], $a[$prefix . 'code'], $a[$prefix . 'file'], $a[$prefix . 'line']);
        return $a;
    }
    public static function castSilencedErrorContext(\_PhpScoper3fe455fa007d\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext $e, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        $sPrefix = "\0" . \_PhpScoper3fe455fa007d\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext::class . "\0";
        ...
        $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'trace'] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\TraceStub($trace, self::$traceArgs);
        return $a;
    }
    public static function castTraceStub(\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\TraceStub $trace, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        if (!$isNested) {
            return $a;
        }
        ...
        for ($j += $trace->numberingOffset - $i++; isset($frames[$i]); ++$i, --$j) {
            ...
            $a[\substr_replace($label, \sprintf('separator=%s&', $frame instanceof \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\EnumStub ? ' ' : ':'), 2, 0)] = $frame;
            $lastCall = $call;
        }
    ...
    public static function castFrameStub(\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\FrameStub $frame, array $a, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested)
    {
        if (!$isNested) {
            return $a;
        }
        ...
        if (isset($f['file'], $f['line'])) {
            ...
            if (isset(self::$framesCache[$cacheKey])) {
                ...
                self::$framesCache[$cacheKey] = $a[$prefix . 'src'] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\EnumStub(["\0~{$srcAttr}\0{$srcKey}" => $src]);
            }
        }
        ...
        if ($frame->keepArgs && !empty($f['args'])) {
            $a[$prefix . 'arguments'] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ArgsStub($f['args'], $f['function'], $f['class']);
        }
        return $a;
    }
    private static function filterExceptionArray(string $xClass, array $a, string $xPrefix, int $filter) : array
    {
        ...
        if (!($filter & \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE) && $trace) {
            if (isset($a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line'])) {
                self::traceUnshift($trace, $xClass, $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line']);
            }
            $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL . 'trace'] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\TraceStub($trace, self::$traceArgs);
        }
        ...
        if (isset($a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line'])) {
            $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'] = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\LinkStub($a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'file'], $a[\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::PREFIX_PROTECTED . 'line']);
        }
        return $a;
    }
    ...
    private static function extractSource(string $srcLines, int $line, int $srcContext, string $lang, ?string $file, array $frame) : \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\EnumStub
    {
        $srcLines = \explode("\n", $srcLines);
        $src = [];
        ...
        if ($frame['function'] ?? \false) {
            ...
            try {
                ...
                $stub->class .= \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature(\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($caller, [], $stub, \true, \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE));
        ...
        foreach ($src as $i => $c) {
            ...
            $c = \substr($c, 0, -1);
            if ($i !== $srcContext) {
                $c = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ConstStub('default', $c);
            } else {
                $c = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\ConstStub($c, $stub ? 'in ' . $stub->class : '');
                if (null !== $file) {
                    $c->attr['file'] = $file;
                    $c->attr['line'] = $line;
                }
        ...
        return new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Caster\EnumStub($srcLines);
    }
}
