 ...
 */
class HtmlDumper extends \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     * {@inheritdoc}
     */
    public function dump(\_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, array $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, bool $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \_PhpScoper5aadddf2c2bd\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
