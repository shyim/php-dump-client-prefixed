 ...
 */
class VarCloner extends \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\AbstractCloner
{
    private static $gid;
    ...
    protected function doClone($var)
    {
        ...
        $arrayStub = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub();
        $arrayStub->type = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub::TYPE_ARRAY;
        $fromObjCast = \false;
        for ($i = 0; $i < $len; ++$i) {
                ...
                switch (\true) {
                    ...
                    case \is_string($v):
                        ...
                        if (!\preg_match('//u', $v)) {
                            ...
                            $stub = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub::TYPE_STRING;
                            $stub->class = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub::STRING_UTF8;
                            $stub->cut = $cut;
                    ...
                    case \is_object($v):
                        if (empty($objRefs[$h = \spl_object_id($v)])) {
                            ...
                            if ($v !== $stub->value) {
                                if (\_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT !== $stub->type || null === $stub->value) {
                                    break;
                                }
                    ...
                    default:
                        ...
                        if (empty($resRefs[$h = (int) $v])) {
                            $stub = new \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \_PhpScoper3fe455fa007d\Symfony\Component\VarDumper\Cloner\Stub::TYPE_RESOURCE;
