...
class Section
{
    ...
    public function startEvent(string $name, ?string $category)
    {
        if (!isset($this->events[$name])) {
            $this->events[$name] = new \_PhpScoper3fe455fa007d\Symfony\Component\Stopwatch\StopwatchEvent($this->origin ?: \microtime(\true) * 1000, $category, $this->morePrecision, $name);
        }
