...
if (!\function_exists('normalizer_is_normalized')) {
    function normalizer_is_normalized($string, $form = \_PhpScoper3fe455fa007d\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
        return \_PhpScoper3fe455fa007d\Symfony\Polyfill\Intl\Normalizer\Normalizer::isNormalized($string, $form);
    }
}
if (!\function_exists('normalizer_normalize')) {
    function normalizer_normalize($string, $form = \_PhpScoper3fe455fa007d\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
