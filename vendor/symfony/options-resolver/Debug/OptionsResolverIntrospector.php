 ...
 */
namespace _PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Debug;

use _PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
use _PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
use _PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\OptionsResolver;
/**
...
{
    private $get;
    public function __construct(\_PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\OptionsResolver $optionsResolver)
    {
        $this->get = \Closure::bind(function ($property, $option, $message) {
            /** @var OptionsResolver $this */
            if (!$this->isDefined($option)) {
                throw new \_PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException(\sprintf('The option "%s" does not exist.', $option));
            }
            if (!\array_key_exists($option, $this->{$property})) {
                throw new \_PhpScoper3fe455fa007d\Symfony\Component\OptionsResolver\Exception\NoConfigurationException($message);
            }
