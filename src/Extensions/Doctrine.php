...
namespace _PhpScoper3fe455fa007d\PhpDumpClient\Extensions;
...
class Doctrine
{
    ...
    public function __construct(\_PhpScoper3fe455fa007d\PhpDumpClient\Client $client)
    {
        $this->client = $client;
    }
    public function logQueryBuilder($queryBuilder) : \_PhpScoper3fe455fa007d\PhpDumpClient\Client
    {
        ...
        $runnableQuery = \preg_replace_callback('/\\?|((?<!:):[a-z0-9_]+)/i', static function ($matches) use($params, &$i) {
